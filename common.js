                    ...
                    [...item].map((el, i) => {
                        ...
                        if (i < count) {
                            if (!isMob) {
                                ...
                                gsap.set(item[0], {
                                    x:() => (window.innerWidth > 1200)? center.x - 400 :  center.x - 200,
                                    y: () => (window.innerWidth > 1200)? center.y - 100 :  center.y - 100,
                                });
                                gsap.set(item[1], {
                                    x:() => (window.innerWidth > 1200)? center.x + 100 :  center.x + 80,
                                    y: () => (window.innerWidth > 1200)? center.y - 30 :  center.y - 80,
                                });
                                gsap.set(item[2], {
                                    x:center.x,
                                    y: () => (window.innerWidth > 1200)? center.y + 200 :  center.y - 10,
                                });
                            } else {
                                gsap.set(el, {
                                    display: "block",
